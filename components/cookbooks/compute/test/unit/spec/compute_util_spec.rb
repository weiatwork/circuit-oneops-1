...
describe 'get_image' do
  ...
  default_image = Image.new('CentOS-7.3.1611-x86_64-minimal-cloud-init RC10', '13760d35-494e-4e50-8428-617d04c4b644')
  ostype = 'CentOS-7.3'
  ...
  context 'When FAST_IMAGE flag is false' do
    it '' do
      return_image = get_image(images, Image.new('randomString', 'randomString'), 'false', 'true', default_image, false, ostype)
