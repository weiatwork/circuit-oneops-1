...
describe 'azurekeypair::add' do
  ...
  it 'adds the resource group and availability set' do
    ...
    expect(chef_run).to add_azurekeypair_resource_group('Resource Group')
    expect(chef_run).to add_azurekeypair_availability_set('Availability Set')
  end
end