...
AZURE_TESTS_PATH = "#{COOKBOOKS_PATH}/azure_lb/test/integration/add/serverspec/tests".freeze
AZURE_GATEWAY_TESTS_PATH = "#{COOKBOOKS_PATH}/azuregateway/test/integration/add/serverspec/tests".freeze
OPENSTACK_TESTS_PATH = "#{COOKBOOKS_PATH}/lb/test/integration/add/serverspec/tests".freeze
