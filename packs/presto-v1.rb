         ...
         :payloads => {
           ...
           'clusterCoord' => {
             ...
             'definition' => '{
               ...
               "direction": "to",
               "targetClassName": "manifest.oneops.1.Presto-cluster-v1",
               "relations": [
                 { "returnObject": false,
                   "returnRelation": false,
...
# managed_via
['presto', 'artifact', 'java-coord', 'user-coord', 'os-coord',
    'presto_coordinator', 'presto_mysql', 'presto_cassandra',
    'presto_swift', 'client-yarn-coord' ].each do |from|
