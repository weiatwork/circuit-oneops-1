...
resource "compute",
    ...
    :attributes => {
        ...
        'sysctl' => '{
            ...
            "net.ipv4.tcp_mem":"1529280 2039040 3058560",
            "net.ipv4.udp_mem":"1529280 2039040 3058560",
            "fs.file-max":"1611021"
        }'
    }
...
resource "solrcloud",
    ...
    :requires => {
        "constraint" => "1..1",
        "services" => "maven,mirror,*solr-service"
    },
    :attributes => {
...
resource "solr-collection",
    ...
    :attributes => {
        ...
        'updateHandler_autoCommit_maxTime' => '300000',
        'updateHandler.autoCommit.maxDocs' => '-1',
        'updateHandler.autoSoftCommit.maxTime' => '30000',
        'updateHandler.updateLog.numRecordsToKeep' => '50000',
        'updateHandler.updateLog.maxNumLogsToKeep' => '10',
        'indexConfig.mergePolicyFactory.maxMergeAtOnce' => '10',
        'indexConfig.mergePolicyFactory.segmentsPerTier' => '10',
        'query.filterCache.size' => '128',
