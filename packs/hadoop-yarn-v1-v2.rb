include_pack "base"
name "hadoop-yarn-v1"
description "Hadoop YARN (v1.v2 build)"
type "Platform"
category "Hadoop"
version "2"
...
# dummy cluster component, used strictly to scale data nodes
resource "dn-hadoop-yarn-cluster",
    :cookbook => "oneops.1.hadoop-yarn-cluster-v1",
    :design => false,
...
[{ :from => 'dn-hadoop-yarn-cluster', :to => 'dn-hadoop-yarn' }].each do |link|
    relation "#{link[:from]}::depends_on::#{link[:to]}",
...
[
    ...
    { :from => 'dn-hadoop-yarn-cluster', :to => 'compute' }
].each do |link|
